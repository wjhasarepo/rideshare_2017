...
add_index device_users, [email], name: index_device_users_on_email
add_index device_users, [uid, provider], name: index_device_users_on_uid_and_provider, unique: true
